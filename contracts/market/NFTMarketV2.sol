...
contract NFTMarketV2 is IERC721Receiver,  ReentrancyGuard {
        ...
        returns(uint)
    {
        ...
        emit eveNewSales(obj.id, tokenId, msg.sender, nft, address(0x0), startTime, durationTime, tmpMaxPrice, tmpMinPrice, 0,obj.currency);
        return _salesAmount;
    }

    function buy(uint index,uint256 amount)
        public
        nonReentrant
        ...
        payable 
    {
        ...
        require (tmpPrice >= price, "umm.....  your price is too low");
        ...
        // fire event
        emit eveSales(index, obj.tokenId, msg.sender, price, tipsFee,obj.currency);
    }
